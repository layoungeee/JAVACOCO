...
public class Chanel06Info extends JFrame{
	

	public Chanel06Info(String title, int width, int height) {
         setTitle(title);
       ...
       ImageIcon logo = new ImageIcon("images/javacoco.png");
        JLabel logoLabel = new JLabel(logo);
         ...
         //상품정보---------------------------------------------------------------------------------
          ...
          ImageIcon itemImage = new ImageIcon("itemImages2/chanel06.jpg");
	      ...
	      JLabel name = new JLabel("[샤넬] 알뤼르 옴므 스포츠 오 드 뚜왈렛");
	      JLabel price = new JLabel("109,900원");
	      ...
	      JLabel ch01 = new JLabel(new ImageIcon("images/ch71.jpg"));
	      JLabel ch02 = new JLabel(new ImageIcon("images/ch72.jpg"));
	      JLabel ch03 = new JLabel(new ImageIcon("images/ch73.jpg"));
