...
public class Chanel07Info extends JFrame{
	

	public Chanel07Info(String title, int width, int height) {
         setTitle(title);
       ...
       ImageIcon logo = new ImageIcon("images/javacoco.png");
        JLabel logoLabel = new JLabel(logo);
         ...
         //상품정보---------------------------------------------------------------------------------
          ...
          ImageIcon itemImage = new ImageIcon("itemImages2/chanel07.jpg");
	      ...
	      JLabel name = new JLabel("[샤넬] 블루 드 샤넬 빠르펭");
	      JLabel price = new JLabel("156,700원");
	      ...
	      JLabel ch01 = new JLabel(new ImageIcon("images/ch51.jpg"));
	      JLabel ch02 = new JLabel(new ImageIcon("images/ch52.jpg"));
	      JLabel ch03 = new JLabel(new ImageIcon("images/ch53.jpg"));
