...
public class Dior02Info extends JFrame{
	

	public Dior02Info(String title, int width, int height) {
         setTitle(title);
       ...
       ImageIcon logo = new ImageIcon("images/javacoco.png");
        JLabel logoLabel = new JLabel(logo);
         ...
         //상품정보---------------------------------------------------------------------------------
          ...
          ImageIcon itemImage = new ImageIcon("itemImages2/dior02.jpg");
	      ...
	      JLabel name = new JLabel("[디올] 미스 디올 블루밍 부케");
	      JLabel price = new JLabel("76,400원");
	      ...
	      JLabel ch01 = new JLabel(new ImageIcon("images/dior21.jpg"));
	      JLabel ch02 = new JLabel(new ImageIcon("images/dior22.jpg"));
	      JLabel ch03 = new JLabel(new ImageIcon("images/dior23.jpg"));
