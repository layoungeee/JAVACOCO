...
public class Chanel03Info extends JFrame{
	

	public Chanel03Info(String title, int width, int height) {
         setTitle(title);
       ...
       ImageIcon logo = new ImageIcon("images/javacoco.png");
        JLabel logoLabel = new JLabel(logo);
         ...
         //상품정보---------------------------------------------------------------------------------
          ...
          ImageIcon itemImage = new ImageIcon("itemImages2/chanel03.jpg");
	      ...
	      JLabel price = new JLabel("123,000원");
	      ...
	      JLabel ch01 = new JLabel(new ImageIcon("images/ch41.jpg"));
	      JLabel ch02 = new JLabel(new ImageIcon("images/ch42.jpg"));
	      JLabel ch03 = new JLabel(new ImageIcon("images/ch43.jpg"));
