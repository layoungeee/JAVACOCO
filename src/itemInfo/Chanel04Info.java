...
public class Chanel04Info extends JFrame{
	

	public Chanel04Info(String title, int width, int height) {
         setTitle(title);
       ...
       ImageIcon logo = new ImageIcon("images/javacoco.png");
        JLabel logoLabel = new JLabel(logo);
         ...
         //상품정보---------------------------------------------------------------------------------
          ...
          ImageIcon itemImage = new ImageIcon("itemImages2/chanel04.jpg");
	      ...
	      JLabel name = new JLabel("[샤넬] 가브리엘 샤넬 에센스 오 드 빠르펭");
	      JLabel price = new JLabel("113,100원");
	      ...
	      JLabel ch01 = new JLabel(new ImageIcon("images/ch31.jpg"));
	      JLabel ch02 = new JLabel(new ImageIcon("images/ch32.jpg"));
	      JLabel ch03 = new JLabel(new ImageIcon("images/ch33.jpg"));
