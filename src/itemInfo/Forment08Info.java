...
public class Forment08Info extends JFrame{
	

	public Forment08Info(String title, int width, int height) {
         setTitle(title);
       ...
       ImageIcon logo = new ImageIcon("images/javacoco.png");
        JLabel logoLabel = new JLabel(logo);
         ...
         //상품정보---------------------------------------------------------------------------------
          ...
          ImageIcon itemImage = new ImageIcon("itemImages2/forment08.jpg");
	      ...
	      JLabel name = new JLabel("[포맨트] 퍼퓸 코튼키스");
	      JLabel price = new JLabel("39,000원");
	      ...
	      JLabel ch01 = new JLabel(new ImageIcon("images/fmt81.jpg"));
	      JLabel ch02 = new JLabel(new ImageIcon("images/fmt82.jpg"));
	      JLabel ch03 = new JLabel(new ImageIcon("images/fmt83.jpg"));
