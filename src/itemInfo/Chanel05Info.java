...
public class Chanel05Info extends JFrame{
	

	public Chanel05Info(String title, int width, int height) {
         setTitle(title);
       ...
       ImageIcon logo = new ImageIcon("images/javacoco.png");
        JLabel logoLabel = new JLabel(logo);
         ...
         //상품정보---------------------------------------------------------------------------------
          ...
          ImageIcon itemImage = new ImageIcon("itemImages2/chanel05.jpg");
	      ...
	      JLabel name = new JLabel("[샤넬] 파리 리비에라 샤넬 오 드 뚜왈렛");
	      JLabel price = new JLabel("98,100원");
	      ...
	      JLabel ch01 = new JLabel(new ImageIcon("images/ch61.jpg"));
	      JLabel ch02 = new JLabel(new ImageIcon("images/ch62.jpg"));
	      JLabel ch03 = new JLabel(new ImageIcon("images/ch63.jpg"));
