...
public class Forment03Info extends JFrame{
	

	public Forment03Info(String title, int width, int height) {
         setTitle(title);
       ...
       ImageIcon logo = new ImageIcon("images/javacoco.png");
        JLabel logoLabel = new JLabel(logo);
         ...
         //상품정보---------------------------------------------------------------------------------
          ...
          ImageIcon itemImage = new ImageIcon("itemImages2/forment03.jpg");
	      ...
	      JLabel name = new JLabel("[포맨트] 퍼퓸 코튼메모리 벚꽃 에디션");
	      JLabel price = new JLabel("68,400원");
	      ...
	      JLabel ch01 = new JLabel(new ImageIcon("images/fmt31.jpg"));
	      JLabel ch02 = new JLabel(new ImageIcon("images/fmt32.jpg"));
	      JLabel ch03 = new JLabel(new ImageIcon("images/fmt33.jpg"));
