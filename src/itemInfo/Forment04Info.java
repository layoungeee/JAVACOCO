...
public class Forment04Info extends JFrame{
	

	public Forment04Info(String title, int width, int height) {
         setTitle(title);
       ...
       ImageIcon logo = new ImageIcon("images/javacoco.png");
        JLabel logoLabel = new JLabel(logo);
         ...
         //상품정보---------------------------------------------------------------------------------
          ...
          ImageIcon itemImage = new ImageIcon("itemImages2/forment04.jpg");
	      ...
	      JLabel name = new JLabel("[포맨트] 퍼퓸 코튼 브리즈");
	      JLabel price = new JLabel("39,900원");
	      ...
	      JLabel ch01 = new JLabel(new ImageIcon("images/fmt41.jpg"));
	      JLabel ch02 = new JLabel(new ImageIcon("images/fmt42.jpg"));
	      JLabel ch03 = new JLabel(new ImageIcon("images/fmt43.jpg"));
